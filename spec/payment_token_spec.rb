  ...
  describe "#initialize" do
    ...
    context "with invalid input" do
      it "raises ParseError for invalid JSON" do
        ...
        }.to raise_error(ApplePayDecryption::ParseError, /Invalid JSON/)
      end

      it "raises ParseError for non-string/hash input" do
        expect {
          described_class.new(123)
        }.to raise_error(ApplePayDecryption::ParseError, /must be a JSON string or Hash/)
      end
    end
    ...
    context "with missing required fields" do
      it "raises ValidationError when data is missing" do
        ...
        }.to raise_error(ApplePayDecryption::ValidationError, /Missing required fields: data/)
      end
      ...
      it "raises ValidationError when header fields are missing" do
        ...
        expect {
          described_class.new(token_hash)
        }.to raise_error(ApplePayDecryption::ValidationError, /Missing required header fields/)
      end
      ...
      it "raises ValidationError when header is not a hash" do
        ...
        expect {
          described_class.new(token_hash)
        }.to raise_error(ApplePayDecryption::ValidationError, /Header must be a hash/)
      end
    end
  end
